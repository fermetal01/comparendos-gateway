...
import { InfraccionComponent } from 'app/entities/infraccion/infraccion.component';
...
describe('Component Tests', () => {
  describe('Infraccion Management Component', () => {
    let comp: InfraccionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InfraccionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.infraccions && comp.infraccions[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
