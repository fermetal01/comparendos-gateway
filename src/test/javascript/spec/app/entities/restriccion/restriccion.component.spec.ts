...
import { RestriccionComponent } from 'app/entities/restriccion/restriccion.component';
...
describe('Component Tests', () => {
  describe('Restriccion Management Component', () => {
    let comp: RestriccionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RestriccionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.restriccions && comp.restriccions[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
