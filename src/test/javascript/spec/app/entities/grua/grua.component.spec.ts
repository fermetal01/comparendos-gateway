...
import { GruaComponent } from 'app/entities/grua/grua.component';
import { GruaService } from 'app/entities/grua/grua.service';
import { Grua } from 'app/shared/model/grua.model';

describe('Component Tests', () => {
  describe('Grua Management Component', () => {
    let comp: GruaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GruaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.gruas && comp.gruas[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
